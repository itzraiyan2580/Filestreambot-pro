...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'rotten-maurise-orange-fox-631ad9a0.koyeb.app'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'rotten-maurise-orange-fox-631ad9a0.koyeb.app:8080')) if not ON_HEROKU or getenv('FQDN', '') else APP_NAME+'.herokuapp.com'
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', '-1002026477147'))
